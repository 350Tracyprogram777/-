...
if (!Array) {
  ...
  (_easycom_ss_topTabar2 + _easycom_newsOne2 + _easycom_bottomMore2 + _easycom_uni_icons2 + _easycom_uni_popup2 + _easycom_ss_twoAlert2)();
}
...
if (!Math) {
  (_easycom_ss_topTabar + _easycom_newsOne + _easycom_bottomMore + _easycom_uni_icons + _easycom_uni_popup + _easycom_ss_twoAlert)();
}
const _sfc_main = {
  __name: "list",
  setup(__props) {
      ...
      ssAlert.value.showModalDic({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            newsApi.adminEdit(dic).then((res2) => {
              const inx = dataArr.value.findIndex(function(a, b) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        k: common_vendor.sr(rejectPop, "ff87f46e-3", {
          "k": "rejectPop"
        }),
        l: common_vendor.sr(ssAlert, "ff87f46e-5", {
          "k": "ssAlert"
        })
      };
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/BOEINGcode/b787/ninini/pageAdmin/newsArticle/list.vue"]]);
