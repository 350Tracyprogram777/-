...
if (!Array) {
  ...
  (_easycom_ss_topTabar2 + _easycom_houseRent2 + _easycom_bottomMore2 + _easycom_uni_icons2 + _easycom_uni_popup2 + _easycom_ss_twoAlert2)();
}
...
if (!Math) {
  (_easycom_ss_topTabar + _easycom_houseRent + _easycom_bottomMore + _easycom_uni_icons + _easycom_uni_popup + _easycom_ss_twoAlert)();
}
const _sfc_main = {
  __name: "list",
  setup(__props) {
      ...
      ssAlert.value.showModalDic({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            houseRentApi.adminEdit(dic).then((res2) => {
              const inx = dataArr.value.findIndex(function(a, b) {
      ...
      return {
        ...
        c: common_vendor.f(dataArr.value, (item, index, i0) => {
          return {
            ...
            d: common_vendor.o(changeState, index),
            e: common_vendor.o(showErr, index),
            f: common_vendor.o(navToEdit, index),
            g: index,
            h: "2154771a-1-" + i0,
            i: common_vendor.p({
              admin: true,
        ...
        k: common_vendor.sr(rejectPop, "2154771a-3", {
          "k": "rejectPop"
        }),
        l: common_vendor.sr(ssAlert, "2154771a-5", {
          "k": "ssAlert"
        })
      };
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/BOEINGcode/b787/ninini/pageAdmin/houseRent/list.vue"]]);
